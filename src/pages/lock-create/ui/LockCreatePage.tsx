...
/** 음악 검색 선택만 실제 연동하고 저장·사진 기능은 구현 예정으로 유지하는 자물쇠 작성 화면이다. */
      ...
      <div className="static-page-content lock-create-content">
        ...
        <section className="surface-card lock-create-card">
          ...
          <div className="lock-create-photo" role="status">
            <span aria-hidden="true">▧</span>사진 추가 기능은 구현 예정입니다.
          </div>
        ...
        <p className="lock-create-autosave">자물쇠 저장 기능은 구현 예정입니다.</p>
      </div>
